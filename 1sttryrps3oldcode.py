...
model_1=TinyVGG(input_shape=3,hidden_units=20,output_shape=len(train_data_augment.classes)).to(device)
...
model_path = os.path.join(save_dir, 'first_rps_model_with_more_data.pth')
